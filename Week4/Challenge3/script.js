...
function show(button_element) {
    ...
    */
    ...
    taname = button_element.id;
    console.log(taname);
    factbox = document.getElementById("fact-box");
    factbox.innerText = facts[taname];
    taphoto = document.getElementById("ta-photo");
    taphoto.src = "photos/" + taname + ".jpg";
